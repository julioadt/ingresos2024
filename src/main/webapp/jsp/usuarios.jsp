    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item"
               href="jsp/reportes.jsp?reporte=usuarios&codigo=<%out.print(rs.getString(1)); %>"
...
<%
  ...
  out.println("error PSQL"+ e); 
   ...
   try{
      ...
      ResultSet rs = null;
      st = conn.createStatement();
      st.executeUpdate("insert into usuarios (usu_nombre,usu_clave,usu_rol,usu_estado)values('"+nombre+"','"+clave +"', '"+rol+"','"+estado+"')");
...
out.println("error PSQL" + e);
   ...
   try {
        Statement st = null;
        st = conn.createStatement();
        st.executeUpdate("update usuarios set usu_nombre='" + nombre +"', usu_clave='"+clave+"', usu_rol='"+rol+"',usu_estado='"+estado+"' where id_usuarios='" + pk + "'");
...
<%
  ...
  out.println("error PSQL"+ e); 
   ...
   try {
        Statement st = null;
        st = conn.createStatement();
        st.executeUpdate("delete from usuarios where id_usuarios='" + pk + "'");
