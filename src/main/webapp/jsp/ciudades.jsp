                            ...
                            <div class="dropdown-menu">
                                ...
                                >
                                 <a class="dropdown-item"
                                    href="jsp/reportes.jsp?reporte=ciudad&codigo=<%out.print(rs.getString(1)); %>"
...
out.println("error PSQL" + e);
   ...
   try {
        Statement st = null;
        st = conn.createStatement();
        st.executeUpdate("update ciudades set nombre='" + nombre +"' where id='" + pk + "'");
...
<%
  ...
  out.println("error PSQL"+ e); 
   ...
   try {
        Statement st = null;
        st = conn.createStatement();
        st.executeUpdate("delete from ciudades where id='" + pk + "'");
