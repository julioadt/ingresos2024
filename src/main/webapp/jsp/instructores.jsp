...
<%  
 if(request.getParameter("listar") != null && request.getParameter("listar").equals("listar")){
   ...
   rs = st.executeQuery("select * from instructores;");
   while(rs.next()){
%>
<tr>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item"
                   href="jsp/reportes.jsp?reporte=instructor&codigo=<%out.print(rs.getString(1)); %>"
...
<%
  ...
  out.println("error PSQL"+ e); 
   ...
   try{
      ...
      ResultSet rs = null;
      st = conn.createStatement();
      st.executeUpdate("insert into instructores (nombre , apellido) values('" + nombre + "','" + apellido + "')");
...
String apellido = request.getParameter("apellido");
   ...
   try {
        Statement st = null;
        st = conn.createStatement();
        st.executeUpdate("update instructores set nombre='" + nombre +"' , apellido='" + apellido +"' where id='" + pk + "'");
   ...
   try {
        Statement st = null;
        st = conn.createStatement();
        st.executeUpdate("delete from instructores where id='" + pk + "'");
