...
<script src="js/tipodeexamenes.js"></script>
<div class="card">
    <div class="card-body">
        <form id="form">
            <div class="row mb-3">
...
<div class="card">
    <div class="col-sm-10">
        <a  href="jsp/reportes.jsp?reporte=tipodeexamenes"id="boton" type="button" class="btn btn-primary">Reportes</a>
                </div>
    <h5 class="card-header">Datos del Tipodeexamenes</h5>
