...
<script src="js/examenesp.js"></script>
<div class="card">
    <div class="card-body">
        <form id="form">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="puntaje" name="puntaje" placeholder="" />
                </div>
            </div>
             <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="text" class="form-control" id="promedio" name="promedio" placeholder="" />
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <select class="form-control" id="instructores" name="instructores" placeholder=""></select>
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label" for="basic-default-name">Tipo de examen</label>
                <div class="col-sm-10">
                    <select class="form-control" id="tipodeexamenes" name="tipodeexamenes" placeholder=""></select>
                </div>
            </div>
...
<div class="card">
    ...
    <h5 class="card-header">Datos del Examen</h5>
