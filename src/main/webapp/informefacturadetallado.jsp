                    ...
                    function listadoconceptosajax() {
                        $.ajax({
                            ...
                            success: function (response) {
                                $("#concepto").html($("#concepto").html() + response.trim());
                            }
                        });
                    }

                    function informe() {
                        location.href= "jsp/informe.jsp?informe=facturadetallado&inicio=" +  $("#fechainicio").val() + "&fin=" + $("#fechafin").val() + "&codigo=" + $("#concepto").val();
                    }
