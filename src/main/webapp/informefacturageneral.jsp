...
<div class="card">
    <div class="card-body">
        <form id="form">
            ...
            <div class="row mb-3">
                <label class="col-form-label" for="basic-default-name">Cliente</label>
                <div class="col-sm-10">
                    <select class="form-control" id="postulante">
                    ...
                    function listadopostulantesajax() {
                        $.ajax({
                            ...
                            success: function (response) {
                                $("#postulante").html($("#postulante").html() + response.trim());
                            }
                        });
                    }

                    function informe() {
                        location.href= "jsp/informe.jsp?informe=facturageneral&inicio=" +  $("#fechainicio").val() + "&fin=" + $("#fechafin").val() + "&codigo=" + $("#postulante").val();
                    }
