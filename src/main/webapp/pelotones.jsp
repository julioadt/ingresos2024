...
<script src="js/pelotones.js"></script>
<div class="card">
    <div class="card-body">
        <form id="form">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" name="pk" id="pk">
                    <input type="hidden" name="listar" id="listar" value="agregar">
                    <select  class="form-control" id="compañia" name="compañia" placeholder=""></select>
                </div>  
            </div>
            <br>
            <br>
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <input type="hidden" name="pk" id="pk">
                    <input type="hidden" name="listar" id="listar" value="agregar">
                    <select  class="form-control" id="instructor" name="instructor" placeholder=""></select>
                </div>
            </div>
            <br>
            <br>
...
<div class="card">
    <div class="col-sm-10">
        <a  href="jsp/reportes.jsp?reporte=pelotones"id="boton" type="button" class="btn btn-primary">Reportes</a>
                </div>
    <h5 class="card-header">Datos del Pelotones</h5>
